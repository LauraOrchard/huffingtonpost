		...
		<blockquote>
			...
			<ul>
				<li>The male Math Nerd will most likely be between 12 and 35, still living at home while attending high
					school, college, graduate school, and eventually their doctoral studies in the fields of pure math, chemistry, engineering, and physics, with a minor
					...
					the proposed solution and rendering their answer in the key of A minor. The male Math Nerd will be using a mobile device or a desktop that
			...
			from the article:
				<ul>
					<li>whether they've seen the challenge before,</li>
					<li>the level of the challenge, and</li>
					<li>whether it merits a comment from them in the comments section.</li>
				</ul>
